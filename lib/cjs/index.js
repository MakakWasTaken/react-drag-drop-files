...
const DrawTypes = ({ types, minSize, maxSize }) => {
  if (types) {
    ...
    if (minSize)
      size += `size <= ${minSize}, `;
    return /* @__PURE__ */ jsxRuntime.jsx("span", { title: `${size}types: ${stringTypes}`, className: "file-types", children: stringTypes });
  }
  return null;
};
...
function useDragging({
  ...
  const handleDragIn = react.useCallback((ev) => {
    ev.preventDefault();
    ev.stopPropagation();
    draggingCount++;
  ...
  const handleDragOut = react.useCallback((ev) => {
    ev.preventDefault();
    ev.stopPropagation();
    draggingCount--;
    if (draggingCount > 0)
  ...
  const handleDrag = react.useCallback((ev) => {
    ev.preventDefault();
    ev.stopPropagation();
  }, []);
...
const drawDescription = (currFile, uploaded, typeError, disabled, label) => {
  return typeError ? /* @__PURE__ */ jsxRuntime.jsx("span", { children: "File type/size error, Hovered on types!" }) : /* @__PURE__ */ jsxRuntime.jsx(Description, { children: disabled ? /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Upload disabled" }) : !currFile && !uploaded ? /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: label ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx("span", { children: label.split(" ")[0] }),
    " ",
    ...
    /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Uploaded Successfully!" }),
    " Upload another?"
  ] }) });
};
const FileUploader = (props) => {
  ...
  const [currFiles, setFile] = react.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    UploaderWrapper,
    {
      ...
      children: [
        ...
        dragging && /* @__PURE__ */ jsxRuntime.jsx(HoverMsg, { style: dropMessageStyle, children: /* @__PURE__ */ jsxRuntime.jsx("span", { children: hoverTitle || "Drop Here" }) }),
        !children && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(ImageAdd, {}),
          /* @__PURE__ */ jsxRuntime.jsxs(DescriptionWrapper, { error, children: [
            drawDescription(currFiles, uploaded, error, disabled, label),
            /* @__PURE__ */ jsxRuntime.jsx(DrawTypes, { types, minSize, maxSize })
          ] })
        ] }),
        children
      ]
